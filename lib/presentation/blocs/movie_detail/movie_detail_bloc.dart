...
class MovieDetailBloc extends Bloc<MovieDetailEvent, MovieDetailState> {
  ...
  MovieDetailBloc({required this.favoriteBloc, required this.videosBloc, required this.castBloc, required this.getMovieDetail}) : super(MovieDetailInitial());
  ...
  Stream<MovieDetailState> mapEventToState(
    ...
    if(event is MovieDetailLoadEvent)  {
      ...
      favoriteBloc.add(CheckIfFavoriteMovieEvent(event.movId));
    }
  }
}
