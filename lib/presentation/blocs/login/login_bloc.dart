...
import 'package:miusu/domain/entities/login_request_params.dart';
...
class LoginCubit extends Cubit<LoginState> {
  ...
  LoginCubit({required this.loadingCubit, required this.loginUser, required this.logoutUser}) : super(LoginInitial());
